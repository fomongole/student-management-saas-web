    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/60 backdrop-blur-sm p-4 overflow-y-auto">
      <div className="relative w-full max-w-2xl rounded-2xl bg-white shadow-2xl my-8 animate-in zoom-in-95 duration-200">
        ...
        <div className="flex items-center justify-between border-b border-gray-100 p-6 bg-gray-50/50 rounded-t-2xl">
          <div>
            <h3 className="text-xl font-black text-gray-900 tracking-tight">Admit New Student</h3>
            <p className="text-sm font-medium text-gray-500 mt-1">Create a new student profile and assign a class.</p>
          </div>
        ...
        <div className="p-6 max-h-[75vh] overflow-y-auto custom-scrollbar">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div>
              <h4 className="mb-4 text-[10px] font-black text-gray-400 uppercase tracking-widest border-b border-gray-100 pb-2">Student Login & Identity</h4>
            ...
            <div>
              <h4 className="mb-4 text-[10px] font-black text-gray-400 uppercase tracking-widest border-b border-gray-100 pb-2">Academic Details</h4>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                  <label className="mb-2 block text-sm font-bold text-gray-700">Assign to Class <span className="text-red-500">*</span></label>
                  <select 
                    {...register('class_id')} 
