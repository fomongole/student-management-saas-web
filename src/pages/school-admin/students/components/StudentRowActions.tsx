        ...
        {isOpen && (
          <div className="absolute right-0 top-8 z-10 w-48 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5">
            <div className="py-1">
              ...
              >
                <Banknote className="mr-3 h-4 w-4 text-green-600 group-hover:text-green-700" /> 
                Financials
              </button>
              ...
              {/* ✅ NEW: Soft Delete / Change Status Option */}
              <div className="border-t border-gray-100 my-1"></div>
              <button 
                onClick={() => { setIsOpen(false); setIsStatusOpen(true); }} 
                className="group flex w-full items-center px-4 py-2 text-sm text-orange-600 hover:bg-orange-50 font-medium"
              >
