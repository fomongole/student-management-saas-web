    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/60 backdrop-blur-sm p-4 overflow-y-auto">
      <div className="relative w-full max-w-md rounded-xl bg-white shadow-2xl">
        ...
        <div className="flex items-center justify-between border-b border-gray-100 p-5">
          <h3 className="text-lg font-bold text-gray-900">Change Enrollment Status</h3>
          <button 
            onClick={onClose} 
        ...
        <div className="p-6">
          ...
          <div className="mb-6 rounded-lg bg-amber-50 border border-amber-200 p-4">
            <div className="flex items-start">
              ...
              {/* ✅ Added flex-1 and min-w-0 to force text wrapping inside the flex container */}
              <div className="ml-3 flex-1 min-w-0">
                ...
                <div className="mt-1 text-sm text-amber-700">
                  <p className="whitespace-normal break-words leading-relaxed">
                    Changing status to anything other than <strong className="font-bold text-amber-900">ACTIVE</strong> will automatically revoke portal access. Historical grades, fees, and attendance will be safely preserved.
                  </p>
                </div>
              </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            <div>
              <label className="mb-2 block text-sm font-semibold text-gray-700">Select New Status</label>
              <select 
            ...
            <div className="flex justify-end space-x-3 pt-4 border-t border-gray-100 mt-6">
              ...
              <button 
                type="submit" 
                disabled={isPending} 
                className="flex items-center rounded-lg bg-amber-600 px-4 py-2 text-sm font-bold text-white hover:bg-amber-700 disabled:opacity-50 transition-colors shadow-sm shadow-amber-200"
              >
